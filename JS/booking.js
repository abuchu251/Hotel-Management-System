...
function setAmt() {
    ...
    if (pckgType == 1) {
        tax.value = ((1999 * parseInt(numofRooms.value)) * 12 / 100) + " (Birr)";
        totalamt.value = (1999 * parseInt(numofRooms.value)) + parseInt(tax.value) + " (Birr)";;
    }
    else if (pckgType == 2) {
        tax.value = ((3999 * parseInt(numofRooms.value)) * 12 / 100) + " (Birr)";
        totalamt.value = (3999 * parseInt(numofRooms.value)) + parseInt(tax.value) + " (Birr)";;
    }
    else if (pckgType == 3) {
        tax.value = (10999 * parseInt(numofRooms.value)) * 12 / 100 + " (Birr)";
        totalamt.value = (10999 * parseInt(numofRooms.value)) + parseInt(tax.value) + "(Birr)";;
    }
    else if (pckgType == 4) {
        tax.value = (15999 * parseInt(numofRooms.value)) * 12 / 100 + " (Birr)";
        totalamt.value = (15999 * parseInt(numofRooms.value)) + parseInt(tax.value) + " (Birr)";
    }
